      ...
      <header className="bg-white shadow-lg rounded-b-3xl p-4 mb-6">
        <div className="flex items-center justify-between max-w-md mx-auto">
          <div className="flex items-center space-x-3">
            ...
            <div className="w-12 h-12 bg-gradient-to-r from-purple-500 to-purple-700 rounded-2xl flex items-center justify-center animate-pulse-slow">
              <FlaskConical className="text-white" size={24} />
            </div>
            <h1 className="text-2xl font-bold text-gray-800">Science</h1>
          </div>
